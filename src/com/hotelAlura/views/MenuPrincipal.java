...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuPrincipal.class.getResource("/com/hotelAlura/imagenes/aH-40px.png")));
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/hotelAlura/imagenes/menu-img.png")));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/hotelAlura/imagenes/aH-150px.png")));
		panel.add(logo);
		...
		imagenLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/hotelAlura/imagenes/login.png")));
